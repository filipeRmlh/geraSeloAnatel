...
Selo.prototype['draw']=function(){
    ...
    var d = function(){
        ...
        _this.ctx.fillText(_this.numAnatel, (_this.width/2)/_this.scale.x, _this.height*0.84/_this.scale.y);
        _this.canvas.style.borderWidth="1px"; 
        _this.canvas.style.borderStyle="solid"; 
